...
def document_lines(metadata: dict[str, str]) -> list[tuple[str, str]]:
    ...
    return [
        ...
        ("heading", "\u56db\u3001\u73af\u5883\u914d\u7f6e"),
        ("body", "\u63a8\u8350 Ubuntu 22.04\u3001Python 3.10\u3001NVIDIA CUDA 12.4 \u517c\u5bb9\u9a71\u52a8\u548c CUDA \u8bbe\u5907\u3002\u6838\u5fc3\u4f9d\u8d56\u4e3a Jittor 1.3.10.0\u3001NumPy 1.26.4\u3001Pandas 2.2.3\u3001Numba 0.66.0 \u548c nvidia-cudnn-cu12 8.9.7.29\uff1b\u7a00\u758f\u77e9\u9635\u64cd\u4f5c\u7531\u5305\u5185 NumPy CSR \u5b9e\u73b0\u5b8c\u6210\u3002"),
